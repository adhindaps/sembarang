    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/blogpdate/{{ $data->id }}" method="POST" enctype="multipart/form-data" >  
                        @csrf
                        <div class="form-row">
        ...
        <input type="file" name="foto" class="form-control" id="foto" aria-describedby="emailHelp" value="{{ $data->foto }}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="judul" class="form-control" id="inputPassword4" value="{{ $data->jurusan }}"  placeholder="">
                              </div>
                            <div class="form-group col-md-12">
