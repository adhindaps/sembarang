...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>SMK N 1 DLANGGU</title>

    <!-- ========== Favicon Icon ========== -->
    <link rel="shortcut icon" href="
    {{ asset('tem/acep/themeforest/examin/assets/img/favicon.png') }}" type="image/x-icon">

    <!-- ========== Start Stylesheet ========== -->
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/bootstrap.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/font-awesome.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/flaticon-set.css') }}" rel="stylesheet" />
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/elegant-icons.css') }}" rel="stylesheet" />
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/magnific-popup.css') }}" rel="stylesheet" />
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/owl.carousel.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/owl.theme.default.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/animate.css') }}" rel="stylesheet" />
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/bootsnav.css') }}" rel="stylesheet" />
    <link href="{{ asset('tem/acep/themeforest/examin/style.css') }}" rel="stylesheet">
    <link href="{{ asset('tem/acep/themeforest/examin/assets/css/responsive.css') }}" rel="stylesheet" />
    <!-- ========== End Stylesheet ========== -->
    ...
    <!-- ========== Google Fonts ========== -->
    <link href="{{ asset('tem/acep/themeforest/examin/https://fonts.googleapis.com/css?family=Open+Sans') }}" rel="stylesheet">
    <link href="{{ asset('tem/acep/themeforest/examin/https://fonts.googleapis.com/css?family=Poppins:400,500,600,700,800') }}" rel="stylesheet">
...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="{{ asset('tem/acep/themeforest/examin/assets/img/logo-light.png') }}" class="logo logo-display" alt="Logo">
                        <img src="{{ asset('tem/acep/themeforest/examin/assets/img/logo.png') }}" class="logo logo-scrolled" alt="Logo">
                    </a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="index-8.html">Home Version Eight <span class="badge">Trend</span></a></li>
            ...
            <div class="side">
                ...
                <div class="widget">
                    ...
                    <div class="profile-thumb">
                        <img src="{{ asset('tem/acep/themeforest/examin/assets/img/800x800.png') }}" alt="Profile">
                    </div>
                    <ul>
                        ...
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            <h1 data-animation="animated slideInDown">Learn from best online <span>training</span> course</h1>
                        ...
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            <h1 data-animation="animated slideInDown">explore our <span>brilliant</span> graduates</h1>
                                            <p data-animation="animated slideInUp">
                                                Supposing breakfast day fulfilled off depending questions. Whatever boy her exertion his extended. Ecstatic followed handsome drawings entirely mrs one yet outweigh. Of acceptance insipidity remarkably is invitation. 
                                            </p>
                                            <a data-animation="animated slideInUp" class="btn btn-light border btn-md" href="#">Learn more</a>
                        ...
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            <h1 data-animation="animated slideInDown">Join the bigest <span>comunity</span> of eduka</h1>
                                            <p data-animation="animated slideInUp">
                                                Supposing breakfast day fulfilled off depending questions. Whatever boy her exertion his extended. Ecstatic followed handsome drawings entirely mrs one yet outweigh. Of acceptance insipidity remarkably is invitation. 
                                            </p>
                                            <a data-animation="animated slideInUp" class="btn btn-light border btn-md" href="#">Learn more</a>
            ...
            <div class="row">
                <div class="about-info">
                    <div class="col-md-6 thumb">
                        <img src="{{ asset('tem/acep/themeforest/examin/assets/img/about/1.jpg') }}" alt="Thumb">
                    </div>
                ...
                <div class="popular-courses-items">
                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{ asset('tem/acep/themeforest/examin/assets/img/courses/5.jpg') }}" alt="Thumb">
                                </a>
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/') }}assets/img/team/1.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{ asset('tem/acep/themeforest/examin/assets/img/courses/2.jpg') }}" alt="Thumb">
                                </a>
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/team/2.jpg') }}" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                                        <a href="#">Akua Paul</a>
                                        <div class="rating">
                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{ asset('tem/acep/themeforest/examin/assets/img/courses/3.jpg') }}" alt="Thumb">
                                </a>
                                <div class="price">Price: Free</div>
                            </div>
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/team/3.jpg') }}" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="{{ asset('tem/assets/img/courses/4.jpg')}}" alt="Thumb">
                                </a>
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/team/4.jpg') }}" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                                        <a href="#">Huma Park</a>
                                        <div class="rating">
                    ...
                    <div class="col-md-4 col-sm-6 equal-height">
                        <div class="item">
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/team/7.jpg') }}" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                    ...
                    <div class="col-md-12 button text-center">
                        <a class="btn btn-dark effect circle btn-md" href="#">Browse All Courses</a>
                    </div>
    ...
    <!-- Start Fun Factor 
    ============================================= -->
    <div class="fun-factor-area default-padding bottom-less text-center bg-fixed shadow dark-hard" style="background-image: url(assets/img/banner/12.jpg);">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="advisor-carousel owl-carousel owl-theme text-center text-light">
                        ...
                        <div class="advisor-item">
                            <div class="info-box">
                                <img src="{{ asset('tem/acep/themeforest/examin/assets/img/advisor/4.jpg') }}" alt="Thumb">  
                                <div class="info-title">
                                    <h4>Sufia Nilla</h4>
                        ...
                        <div class="advisor-item">
                            <div class="info-box">
                                <img src="{{ asset('tem/acep/themeforest/examin/assets/img/advisor/5.jpg') }}" alt="Thumb">  
                                <div class="info-title">
                                    <h4>Professon. Nuri Paul</h4>
                                    <span>Chemistry specialist</span>
                                </div>
                ...
                <div class="col-md-12">
                    <div class="event-items event-carousel owl-carousel owl-theme">
                        ...
                        <div class="item vertical">
                            <div class="thumb">
                                <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/event/1.jpg') }}" alt="Thumb"></a>
                                <div class="date">
                        ...
                        <div class="item vertical">
                            <div class="thumb">
                                <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/event/2.jpg') }}" alt="Thumb"></a>
                                <div class="date">
                                    <h4><span>18</span> Nov, 2018</h4>
                                </div>
                            </div>
                            <div class="info">
                                <h4>
                                    <a href="#">Local United Nations</a>
                                </h4>
                                <div class="meta">
                                    <ul>
                                        <li><i class="fas fa-clock"></i>  8:00 AM - 5:00 PM</li>
                                ...
                                <a href="#" class="btn btn-gray btn-xsm">
                                    <i class="fas fa-ticket-alt"></i> 66 Available
                                </a>
                            </div>
                        </div>
                        <!-- Single Item -->
                        ...
                        <div class="item vertical">
                            <div class="thumb">
                                <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/event/3.jpg') }}" alt="Thumb"></a>
                                <div class="date">
                        ...
                        <div class="item vertical">
                            <div class="thumb">
                                <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/event/4.jpg') }}" alt="Thumb"></a>
                                <div class="date">
                                    <h4><span>25</span> Dec, 2018</h4>
                                </div>
                            </div>
                            <div class="info">
                                <h4>
                        ...
                        <div class="item vertical">
                            <div class="thumb">
                                <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/event/5.jpg') }}" alt="Thumb"></a>
                                <div class="date">
                                    <h4><span>13</span> Apr, 2019</h4>
                                </div>
                            </div>
                            <div class="info">
                                <h4>
                                ...
                                <a href="#" class="btn btn-gray btn-xsm">
                                    <i class="fas fa-ticket-alt"></i> 88 Available
                                </a>
                            </div>
                        </div>
                        <!-- Single Item -->
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="ac1" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            <p>
                                                She wholly fat who window extent either formal. Removing welcomed civility or hastened is. Justice elderly but perhaps expense six her are another passage. Full her ten open fond walk not down.For request general express unknown are. Esteems it ye sending reached as. Longer lively her design settle tastes advice.  Numerous indulged distance old law you. Total state as merit court green.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="clients-review-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="col-md-5 thumb">
                                <img src="{{ asset('tem/acep/themeforest/examin/assets/img/team/2.jpg') }}" alt="Thumb">
                            </div>
                        ...
                        <div class="item">
                            <div class="col-md-5 thumb">
                                <img src="{{ asset('tem/acep/themeforest/examin/assets/img/team/3.jpg') }}" alt="Thumb">
                            </div>
                            <div class="col-md-7 info">
                                <p>
                                    Procuring continued suspicion its ten. Pursuit brother are had fifteen distant has. Early had add equal china quiet visit. Appear an manner as no limits either praise.. 
                        ...
                        <div class="item">
                            <div class="col-md-5 thumb">
                                <img src="{{ asset('tem/acep/themeforest/examin/assets/img/team/4.jpg') }}" alt="Thumb">
                            </div>
                            <div class="col-md-7 info">
                                <p>
                                    Procuring continued suspicion its ten. Pursuit brother are had fifteen distant has. Early had add equal china quiet visit. Appear an manner as no limits either praise.. 
                        ...
                        <div class="item">
                            <div class="col-md-5 thumb">
                                <img src="{{ asset('tem/acep/themeforest/examin/assets/img/team/7.jpg') }}" alt="Thumb">
                            </div>
                            <div class="col-md-7 info">
                                <p>
                                    Procuring continued suspicion its ten. Pursuit brother are had fifteen distant has. Early had add equal china quiet visit. Appear an manner as no limits either praise.. 
            ...
            <div class="row">
                <div class="blog-items">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/blog/1.jpg') }}" alt="Thumb"></a>
                                <div class="date">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/blog/2.jpg') }}" alt="Thumb"></a>
                                <div class="date">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/blog/3.jpg') }}" alt="Thumb"></a>
                                <div class="date">
                ...
                <div class="col-md-8 clients">
                    <div class="clients-items owl-carousel owl-theme text-center">
                        <div class="single-item">
                            <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/') }}assets/img/clients/1.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/clients/2.png') }}" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/clients/3.png') }}" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/clients/4.png') }}" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/clients/5.png') }}" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/clients/6.png') }}" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/clients/7.png') }}" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/clients/8.png') }}" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="{{ asset('tem/acep/themeforest/examin/assets/img/clients/9.png') }}" alt="Clients"></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Start Footer 
    ============================================= -->
    <footer class="bg-fixed shadow dark-hard default-padding-top text-light" style="background-image: url(assets/img/banner/11.jpg);">
        <div class="container">
            <div class="row">
                <div class="f-items">
                    <div class="col-md-4 item">
                        <div class="f-item">
                            <img src="{{ asset('tem/acep/themeforest/examin/assets/img/logo-light.png') }}" alt="Logo">
                            <p>
    ...
    <!-- jQuery Frameworks
    ============================================= -->
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/jquery-1.12.4.min.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/bootstrap.min.js') }}assets/js/bootstrap.min.js"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/equal-height.min.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/jquery.appear.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/jquery.easing.min.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/modernizr.custom.13711.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/count-to.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/loopcounter.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/jquery.nice-select.min.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/bootsnav.js') }}"></script>
    <script src="{{ asset('tem/acep/themeforest/examin/assets/js/main.js') }}"></script>
