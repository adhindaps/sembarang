				...
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						...
						<div class="category-card_content">
							...
							<p class="category-card_text">Kualifikasi pengajar S1 dan S2 dari lulusan kampus ternama dan memiliki sertifikasi keahlian.</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-4">
				...
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						...
						<div class="category-card_content">
							...
							<p class="category-card_text">Banyak Progeam Beasiswa untuk melanjutkan Pendidikan yang Lebih Tinggi.</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						...
						<div class="category-card_content">
							...
							<p class="category-card_text">Alumni siap kerja, siap kuliah dan siap berwirausaha. Alumni tersebar di berbagai negara Seperti Jepang, Turki, Paris, Jerman, dan lain-lain</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						...
						<div class="category-card_content">
							...
							<p class="category-card_text">Memiliki segudang prestasi baik tingkat lokal, regional maupun nasional.</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						...
						<div class="category-card_content">
							...
							<p class="category-card_text">Merdeka Belajar Telkom Schools (MBTS) dengan 4 Pilar yaitu SDM GURU, Pendidikan Karakter Siswa, KURIKULUM dan Moderenisasi Sarana Prasaranasekolah.</p>
						</div>
					</div>
				</div>
			</div>
