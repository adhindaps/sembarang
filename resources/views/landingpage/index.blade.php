...
<body>
			...
			<div class="row gy-50">
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						<div class="category-card_icon"><img alt="icon" src="{{asset ('1/yeye/html/acadu/demo/assets/img/icon/category_1_1.svg')}}"></div>
						<div class="category-card_content">
							<h3 class="category-card_title"><a href="course.html">Web Development</a></h3>
							<p class="category-card_text">Globally maintain magnetic process with model foster data after ubiuitous architectures.</p><a class="link-btn" href="course.html">Learn More<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						<div class="category-card_icon"><img alt="icon" src="{{asset ('1/yeye/html/acadu/demo/assets/img/icon/category_1_2.svg')}}"></div>
						<div class="category-card_content">
							<h3 class="category-card_title"><a href="course.html">Digital Marketing</a></h3>
							<p class="category-card_text">Ubiuitos maintain magnetic process with model foster data after architectures ubiuitous.</p><a class="link-btn" href="course.html">Learn More<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						<div class="category-card_icon"><img alt="icon" src="{{asset ('1/yeye/html/acadu/demo/assets/img/icon/category_1_3.svg')}}"></div>
						<div class="category-card_content">
							<h3 class="category-card_title"><a href="course.html">UI/UX Design</a></h3>
							<p class="category-card_text">Magnetic maintain Globally process with model architectures data after ubiuitous foster.</p><a class="link-btn" href="course.html">Learn More<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						<div class="category-card_icon"><img alt="icon" src="{{asset ('1/yeye/html/acadu/demo/assets/img/icon/category_1_4.svg')}}"></div>
						<div class="category-card_content">
							<h3 class="category-card_title"><a href="course.html">Finance Managment</a></h3>
							<p class="category-card_text">Genious maintain magnetic process with model foster data after ubiuitous Previoiuslyws.</p><a class="link-btn" href="course.html">Learn More<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						<div class="category-card_icon"><img alt="icon" src="{{asset ('1/yeye/html/acadu/demo/assets/img/icon/category_1_5.svg')}}"></div>
						<div class="category-card_content">
							<h3 class="category-card_title"><a href="course.html">Graphic Design</a></h3>
							<p class="category-card_text">Getting maintain magnetic process with model foster data after ubiuitous architectures.</p><a class="link-btn" href="course.html">Learn More<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-4">
					<div class="category-card">
						<div class="category-card_icon"><img alt="icon" src="{{asset ('1/yeye/html/acadu/demo/assets/img/icon/category_1_6.svg')}}"></div>
						<div class="category-card_content">
							<h3 class="category-card_title"><a href="course.html">Product Marketing</a></h3>
							<p class="category-card_text">Startup maintain magnetic process with model foster data after architectures ubiuitous.</p><a class="link-btn" href="course.html">Learn More<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="space bg-smoke">
		<div class="container">
			<div class="title-area text-center">
				...
				<h2 class="sec-title fw-medium">Our Popular Courses</h2>
			</div>
			<div class="tab-menu1 filter-menu-active">
				<button class="filter-btn active" data-filter="*">All Categories</button> <button class="filter-btn" data-filter=".cat1">Business</button> <button class="filter-btn" data-filter=".cat2">Development</button> <button class="filter-btn" data-filter=".cat3">Marketing</button> <button class="filter-btn" data-filter=".cat4">Finance</button> <button class="filter-btn" data-filter=".cat5">Gaming</button> <button class="filter-btn" data-filter=".cat6">Design</button> <button class="filter-btn" data-filter=".cat7">Data Science</button>
			</div>
			<div class="row gy-4 filter-active">
				<div class="col-md-6 col-xl-4 filter-item cat1 cat3 cat5 cat7">
					<div class="course-box style2">
						<div class="course-img">
							<img alt="course" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/course_3_1.jpg')}}"> <span class="tag">Free</span>
						</div>
						<div class="course-content">
							<h3 class="course-title"><a href="course-details.html">React Tutorial Beginners For Skills Building Carrer</a></h3>
							<div class="course-author">
								<div class="author-info">
									<img alt="author" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/author_2.jpg')}}">
									<div class="info">
										<a class="author-name" href="course.html">Kevin Perry</a> <span class="desig">Instructor</span>
									</div>
								</div>
							...
							<div class="course-meta">
								<span><i class="fal fa-file"></i>Lesson 8</span> <span><i class="fal fa-user"></i>Students 50</span> <span><i class="fal fa-eye"></i>View: 12K</span>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-xl-4 filter-item cat2 cat4 cat6">
					<div class="course-box style2">
						<div class="course-img">
							<img alt="course" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/course_3_2.jpg')}}"> <span class="tag">22.9$</span>
						</div>
						<div class="course-content">
							<h3 class="course-title"><a href="course-details.html">Techs Tutorial Beginners For Skills Building Morani</a></h3>
							<div class="course-author">
								<div class="author-info">
									<img alt="author" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/author_2.jpg')}}">
									<div class="info">
							...
							<div class="course-meta">
								<span><i class="fal fa-file"></i>Lesson 9</span> <span><i class="fal fa-user"></i>Students 55</span> <span><i class="fal fa-eye"></i>View: 13K</span>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-xl-4 filter-item cat3 cat5 cat7">
					<div class="course-box style2">
						<div class="course-img">
							<img alt="course" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/course_3_3.jpg')}}"> <span class="tag">11.9$</span>
						</div>
						<div class="course-content">
							<h3 class="course-title"><a href="course-details.html">Start Tutorial Beginners For Skills Building Korans</a></h3>
							<div class="course-author">
								<div class="author-info">
									<img alt="author" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/author_2.jpg')}}">
									<div class="info">
							...
							<div class="course-meta">
								<span><i class="fal fa-file"></i>Lesson 6</span> <span><i class="fal fa-user"></i>Students 60</span> <span><i class="fal fa-eye"></i>View: 12K</span>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-xl-4 filter-item cat1 cat4 cat6">
					<div class="course-box style2">
						<div class="course-img">
							<img alt="course" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/course_3_4.jpg')}}"> <span class="tag">20.1$</span>
						</div>
						<div class="course-content">
							<h3 class="course-title"><a href="course-details.html">Learn Tutorial Beginners For Skills Building Bakand</a></h3>
							<div class="course-author">
								<div class="author-info">
									<img alt="author" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/author_2.jpg')}}">
									<div class="info">
							...
							<div class="course-meta">
								<span><i class="fal fa-file"></i>Lesson 5</span> <span><i class="fal fa-user"></i>Students 50</span> <span><i class="fal fa-eye"></i>View: 14K</span>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-xl-4 filter-item cat2 cat5 cat6 cat7">
					<div class="course-box style2">
						<div class="course-img">
							<img alt="course" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/course_3_5.jpg')}}"> <span class="tag">Free</span>
						</div>
						<div class="course-content">
							<h3 class="course-title"><a href="course-details.html">Start Tutorial Beginners For Skills Building Tonals</a></h3>
							<div class="course-author">
								<div class="author-info">
									<img alt="author" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/author_2.jpg')}}">
									<div class="info">
							...
							<div class="course-meta">
								<span><i class="fal fa-file"></i>Lesson 12</span> <span><i class="fal fa-user"></i>Students 70</span> <span><i class="fal fa-eye"></i>View: 12K</span>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-xl-4 filter-item cat3 cat1 cat2 cat4">
					<div class="course-box style2">
						<div class="course-img">
							<img alt="course" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/course_3_6.jpg')}}"> <span class="tag">Free</span>
						</div>
						<div class="course-content">
							<h3 class="course-title"><a href="course-details.html">Techs Tutorial Beginners For Skills Building Toiani</a></h3>
							<div class="course-author">
								<div class="author-info">
									<img alt="author" src="{{asset ('1/yeye/html/acadu/demo/assets/img/course/author_2.jpg')}}">
									<div class="info">
							...
							<div class="course-meta">
								<span><i class="fal fa-file"></i>Lesson 11</span> <span><i class="fal fa-user"></i>Students 50</span> <span><i class="fal fa-eye"></i>View: 11K</span>
							</div>
						</div>
					</div>
				</div>
	...
	<section class="bg-title position-relative bg-bottom-right" data-bg-src="{{asset ('1/yeye/html/acadu/demo/assets/img/bg/bg_overlay_4.png')}}">
		<div class="img-left"><img alt="mockup" src="{{asset ('1/yeye/html/acadu/demo/assets/img/normal/mockup_2_1.png')}}"></div>
		<div class="container space z-index-common">
			<div class="row justify-content-end">
				<div class="col-xl-6">
					<div class="title-area mb-30">
						<span class="sub-title">ADMISSION GOING ON</span>
						<h2 class="sec-title fw-medium text-white">Find Your Best Course With Us</h2>
					</div>
					...
					<form action="#" class="course-form mb-2">
						<div class="row">
					...
					</form><a class="as-btn style3" href="course.html">Find Your Course<i class="fas fa-arrow-right ms-2"></i></a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="row slider-shadow as-carousel" data-lg-slide-show="2" data-md-slide-show="2" data-slide-show="3" data-sm-slide-show="1">
				<div class="col-md-6 col-xl-4">
					<div class="blog-card">
						<div class="blog-img"><img alt="blog image" src="{{asset ('1/yeye/html/acadu/demo/assets/img/blog/blog_2_1.jpg')}}"></div>
						<div class="blog-content">
							...
							<h3 class="blog-title"><a href="blog-details.html">Designing Better Link Web Site and Emailsite Valued</a></h3><a class="link-btn" href="blog-details.html">Read Details<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-xl-4">
					<div class="blog-card">
						<div class="blog-img"><img alt="blog image" src="{{asset ('1/yeye/html/acadu/demo/assets/img/blog/blog_2_2.jpg')}}"></div>
						<div class="blog-content">
							<div class="blog-meta style2">
								<a href="blog.html"><i class="far fa-clock"></i>March 16, 2022</a> <a href="blog.html"><i class="far fa-folder"></i>Technology</a>
							</div>
							<h3 class="blog-title"><a href="blog-details.html">Morishing Better Link Web Site and Emailsite galowo</a></h3><a class="link-btn" href="blog-details.html">Read Details<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-xl-4">
					<div class="blog-card">
						<div class="blog-img"><img alt="blog image" src="{{asset ('1/yeye/html/acadu/demo/assets/img/blog/blog_2_3.jpg')}}"></div>
						<div class="blog-content">
							<div class="blog-meta style2">
								<a href="blog.html"><i class="far fa-clock"></i>March 17, 2022</a> <a href="blog.html"><i class="far fa-folder"></i>Programing</a>
							</div>
							<h3 class="blog-title"><a href="blog-details.html">Kariabnim Better Link Web Site and Emailsite Tanial</a></h3><a class="link-btn" href="blog-details.html">Read Details<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-xl-4">
					<div class="blog-card">
						<div class="blog-img"><img alt="blog image" src="{{asset ('1/yeye/html/acadu/demo/assets/img/blog/blog_2_4.jpg')}}"></div>
						<div class="blog-content">
							<div class="blog-meta style2">
								<a href="blog.html"><i class="far fa-clock"></i>March 18, 2022</a> <a href="blog.html"><i class="far fa-folder"></i>Technology</a>
							</div>
							<h3 class="blog-title"><a href="blog-details.html">Gusakanis Better Link Web Site and Emailsite Monasi</a></h3><a class="link-btn" href="blog-details.html">Read Details<i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="bg-smoke" data-pos-for=".footer-wrapper" data-sec-pos="bottom-half">
		<div class="container as-container3 z-index-common">
			<div class="row gx-10 as-carousel" data-lg-slide-show="5" data-md-slide-show="4" data-slide-show="6" data-sm-slide-show="3" data-xs-slide-show="2">
				<div class="col-auto">
					<div class="insta-box">
						<img alt="Instagram" src="{{asset ('1/yeye/html/acadu/demo/assets/img/insta/insta_1_1.jpg')}}"> <a class="icon-btn" href="https://instagram.com/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
					</div>
				</div>
				<div class="col-auto">
					<div class="insta-box">
						<img alt="Instagram" src="{{asset ('1/yeye/html/acadu/demo/assets/img/insta/insta_1_2.jpg')}}"> <a class="icon-btn" href="https://instagram.com/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
					</div>
				</div>
				<div class="col-auto">
					<div class="insta-box">
						<img alt="Instagram" src="{{asset ('1/yeye/html/acadu/demo/assets/img/insta/insta_1_3.jpg')}}"> <a class="icon-btn" href="https://instagram.com/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
					</div>
				</div>
				<div class="col-auto">
					<div class="insta-box">
						<img alt="Instagram" src="{{asset ('1/yeye/html/acadu/demo/assets/img/insta/insta_1_4.jpg')}}"> <a class="icon-btn" href="https://instagram.com/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
					</div>
				</div>
				<div class="col-auto">
					<div class="insta-box">
						<img alt="Instagram" src="{{asset ('1/yeye/html/acadu/demo/assets/img/insta/insta_1_5.jpg')}}"> <a class="icon-btn" href="https://instagram.com/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
					</div>
				</div>
				<div class="col-auto">
					<div class="insta-box">
						<img alt="Instagram" src="{{asset ('1/yeye/html/acadu/demo/assets/img/insta/insta_1_6.jpg')}}"> <a class="icon-btn" href="https://instagram.com/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
					</div>
				</div>
			</div>
		</div>
