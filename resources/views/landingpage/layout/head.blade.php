<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="{{asset ('1/yeye/html/acadu/demo/assets/img/favicons/apple-icon-57x57.png')}}">
    <link rel="apple-touch-icon" sizes="60x60" href="{{asset ('1/yeye/html/acadu/demo/assets/img/favicons/apple-icon-60x60.png')}}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{asset ('1/yeye/html/acadu/demo/assets/img/favicons/apple-icon-72x72.png')}}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset ('1/yeye/html/acadu/demo/assets/img/favicons/apple-icon-76x76.png')}}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{asset ('1/yeye/html/acadu/demo/assets/img/favicons/apple-icon-114x114.png')}}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{asset ('1/yeye/html/acadu/demo/assets/img/favicons/apple-icon-120x120.png')}}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{asset ('1/yeye/html/acadu/demo/assets/img/favicons/apple-icon-144x144.png')}}">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset ('1/yeye/html/acadu/demo/assets/img/favicons/favicon-16x16.png')}}">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Jost:wght@100;200;300;400;500;600;700;800;900&amp;family=Roboto:wght@100;300;400;500;700&amp;display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{asset ('1/yeye/html/acadu/demo/assets/css/app.min.css')}}">
    <link rel="stylesheet" href="{{asset ('1/yeye/html/acadu/demo/assets/css/fontawesome.min.css')}}">
    <link rel="stylesheet" href="{{asset ('1/yeye/html/acadu/demo/assets/css/style.css')}}">
</head>