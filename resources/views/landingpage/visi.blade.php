                ...
                <div class="col-xxl-9 col-lg-8">
                    <div class="course-single">
                        <div class="course-single-top">
                            <div class="course-img"><img src="mpls/6.jpg" alt="Course Image">
                            </div>
                           
                            <h2 class="course-title">VISI & MISI SMK NEGERI 1 DLANGGU</h2>
                            <div class="course-single-meta"> <a href="course.html"><i
                                        class="fas fa-tags"></i>Hummas SMKN 1 DLANGGU </a> <a href="course.html"><i
                            ...
                            <ul class="nav course-tab" id="courseTab" role="tablist">
                                <li class="nav-item" role="presentation"><a class="nav-link active" id="description-tab"
                                        ...
                                        aria-controls="Coursedescription" aria-selected="true"><i
                                            class="fa-regular fa-bookmark"></i>Visi</a></li>
                                <li class="nav-item" role="presentation"><a class="nav-link" id="curriculam-tab"
                                        ...
                                        aria-selected="false"><i class="fa-regular fa-book"></i>Misi</a></li>
